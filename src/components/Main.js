...
export default function Main ({dataUser}) {
  ...
  return (
    <main className="user">
      ...
      <button className="user__add-story">Add Story</button>
        <article>
          <h2>Title story</h2>
      ...
      <div className="user__friends">Block friends</div>
    </main>
  )
}
